...
namespace dumpInternals {
    ...
    struct EMhwlibPictureV1 {
        ...
        */
        ...
        /* Byte count of the video elementary stream associated
           ...
           1 = used for decoding.
        */
        union EMhwlibPictureStereoscopicData picture_multiview_data; /* 0xb0 */
    ...
    */
    ...
    /*
            4-5 repeat frame
    */
        wxUint32 repeat_frame:2;

    /*
           6-7 pixel format
    */
        wxUint32 pixel_format:2;
    /*
           8-10 bits per pixel
    */
        wxUint32 bits_per_pixel:3;
    /*
           11-13 bit mapping
    */
        wxUint32 bit_mapping:3;
    /*
           14  progressive sequence
    */
        wxUint32 prog_seq:1;
    /*
           15 linear_buffer
    */
        wxUint32 linear_buffer:1;
    /*
           16-19 uv_luma_top_field_ver_phase_offset
    */
        wxUint32 uv_luma_top_field_ver_phase_offset:4;

    /*
           20-23 uv_luma_top_field_hor_phase_offset
    */
        wxUint32 uv_luma_top_field_hor_phase_offset:4;

    /*
           24-27 uv_luma_bot_field_ver_phase_offset
    */
        wxUint32 uv_luma_bot_field_ver_phase_offset:4;

    /*
           28-31 uv_luma_bot_field_hor_phase_offset
    */
        wxUint32 uv_luma_bot_field_hor_phase_offset:4;
 ...
 */
    ...
    struct VideoMicrocodePicture {
        ...
        wxUint32 luma_address;                          /* 0x04 */
        wxUint32 luma_total_width;                      /* 0x08 */
        wxUint32 chroma_address;                        /* 0x0c */
        wxUint32 chroma_total_width;                    /* 0x10 */
        struct EMhwlibWindow luma_position_in_buffer;   /* 0x14 */
        struct EMhwlibWindow chroma_position_in_buffer; /* 0x24 */
        wxUint32 scaled_width;                          /* 0x34 */
        wxUint32 scaled_height;                         /* 0x38 */
        ...
        wxUint32 ar_x;                                  /* 0x7c */
        wxUint32 ar_y;                                  /* 0x80 */
        wxUint32 color_description;                     /* 0x84 */
        wxUint32 first_pts_lo;                          /* 0x88 */
        wxUint32 first_pts_hi;                          /* 0x8c */
        wxUint32 delta_pts;                             /* 0x90 */
        wxUint32 system_pts;                            /* 0x94 */
        wxUint32 timecode;                              /* 0x98 */
        wxUint32 time_increment_resolution;             /* 0x9c */
        union VideoMicrocodePictureDisplayData picture_display_data; /* 0xa0 */
        wxUint32 picture_data_extension;                /* 0xa4 */
        wxUint32 luma_scale;                            /* 0xa8 */
        wxUint32 chroma_scale;                          /* 0xac */
        wxUint32 picture_bytecount;                     /* 0xb0 */
        union EMhwlibPictureStereoscopicData picture_multiview_data; /* 0xb4 */
        wxUint32 user_data_entry_status;	        /* 0xb8 */
        wxUint32 user_data_entry_size;                  /* 0xbc */
        wxUint32 picture_decode_status;                 /* 0xc0 */
        wxUint32 picture_display_status;                /* 0xc4 */
        wxUint32 error_status;                          /* 0xc8 */
        struct EMhwlibPostProcessing post_processing;   /* 0xcc */
        wxUint32 palette_address;                       /* 0xd4 */
        wxUint32 palette_size;                          /* 0xd8 */
        wxUint32 palette_buffer_size;                   /* 0xdc */
        wxUint32 active_format;                         /* 0xe0 */
        wxUint32 horizontal_bar;                        /* 0xe4 */
        wxUint32 vertical_bar;                          /* 0xe8 */
        wxUint32 frame_count;                           /* 0xec */
        wxUint32 native_time_increment_resolution;      /* 0xf0 */
    };

    struct EMhwlibPictureInfoV2 {
        struct VideoMicrocodePicture    Picture;
        wxUint32                        PictureAddress;
    };
